...
import com.shivenshekar.graphparser.util.PathFormatter;
...
public class SearchDemo {
    ...
    public static void main(String[] args) {
        try {
            ...
            if (bfsPath != null) {
                System.out.println(PathFormatter.formatSchemeA(bfsPath));
            } else {
            ...
            if (dfsPath != null) {
                System.out.println(PathFormatter.formatSchemeA(dfsPath));
            } else {
    ...
    private static Path demonstrateBFS(Graph graph, String srcLabel, String dstLabel) {
        ...
        System.out.println("visiting " + PathFormatter.formatSchemeA(initialPath));
        ...
        while (!queue.isEmpty()) {
            ...
            for (DefaultEdge edge : graph.getOutgoingEdges(currentNode)) {
                ...
                if (!visited.contains(neighbor)) {
                    ...
                    System.out.println("visiting " + PathFormatter.formatSchemeA(newPath));
                    queue.add(newPath);
                }
            }
        }
    ...
    private static void demonstrateRandomWalk(Graph graph, String startNode, String endNode) {
        ...
        for (int i = 0; i < successfulPaths.size(); i++) {
            System.out.println((i + 1) + ": " + PathFormatter.formatSimple(successfulPaths.get(i)));
        }
    }
}